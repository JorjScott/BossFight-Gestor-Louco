...
loadSprite('background', 'WppqNCI.jpg')
...
loadSprite('enemy', 'K2KrMIe.png')
loadSprite('enemy2', 'qOVCXw0.png')
loadSprite('enemy3', 'V2F0KdT.png')
...
scene("game", ({ level, score }) => {
  ...
  const levelCfg = {
    ...
    'z': [sprite('enemy'), solid(), scale(0.47), 'dangerous' ],
...
// Agende a destruição após 5 segundos
wait(5, () => {
  destroy(enemy);
});
